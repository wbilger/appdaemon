...
function basemedia_speaker(widget_id, url, skin, parameters)
{
    self = this;
...
function basedisplay_short(widget_id, url, skin, parameters)
{
    // Will be using "self" throughout for the various flavors of "this"
    // so for consistency ...
...
function baselight_short(widget_id, url, skin, parameters)
{
    // Will be using "self" throughout for the various flavors of "this"
    // so for consistency ...
...
function basepresence(widget_id, url, skin, parameters)
{
    // Will be using "self" throughout for the various flavors of "this"
    // so for consistency ...
...
function baserss_alerts(widget_id, url, skin, parameters)
{
    // Will be using "self" throughout for the various flavors of "this"
    // so for consistency ...
    ...
    function show_next_story(self)
    {
        ...
        if (stories[self.story].title == "No watches or warnings in effect, London")//self.fields(self, title2))
            {
            self.set_field(self, "text", "")
            }            
        else
            {
